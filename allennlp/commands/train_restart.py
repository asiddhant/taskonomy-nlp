...
def train_model(params: Params,
    ...
    if validation_data and evaluate_on_validation:
        logger.info("The model will be evaluated using the best epoch weights on validation")
        validation_metrics = evaluate(
                best_model, validation_data, validation_iterator or iterator,
    ...
    if test_data and evaluate_on_test:
        logger.info("The model will be evaluated using the best epoch weights on test")
    ...
    dump_metrics(os.path.join(serialization_dir, "metrics_new.json"), metrics, log=True)
