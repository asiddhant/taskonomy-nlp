...
class ConcatenatedTextFieldEmbedder(TextFieldEmbedder):
    ...
    def __init__(self,
        ...
        super(ConcatenatedTextFieldEmbedder, self).__init__()
    ...
    @classmethod
    def from_params(cls, vocab: Vocabulary, params: Params) -> 'ConcatenatedTextFieldEmbedder':  # type: ignore
        ...
        if token_embedder_params is not None:
            ...
            warnings.warn(DeprecationWarning("the token embedders for ConcatenatedTextEmbedding should now "
