...
@TextFieldEmbedder.register("weighted_average_cached")
class WeightedAverageTextFieldEmbedderCached(TextFieldEmbedder):
    """
    ...
    def __init__(self,
        ...
        super(WeightedAverageTextFieldEmbedderCached, self).__init__()
    ...
    def forward(self, tokens, num_wrapping_dims: int = 0) -> torch.Tensor:
        ...
        if self.use_elmo :  
            ...
            elmo_emb = embedder(tokens['elmo'],words=tokens['metadata'])
    ...
    @classmethod
    def from_params(cls, vocab: Vocabulary, params: Params) -> 'WeightedAverageTextFieldEmbedderCached':  # type: ignore
